...
This project is a playground demonstrating how to import Swift code into a Kotlin Multiplatform (KMP) project using the [spmForKMP](https://spmforkmp.eu/) plugin.
